...
- "scope" sections state exactly what is included, area by area, in plain bullet points a client can check off. Also list what is excluded, key assumptions, and the client's site responsibilities - this prevents scope creep.
- "understanding" sections are a short executive summary proving we listened: what the client requires, what the survey identified, and the overall objective. The reader should think "they understand our problem".
- "why_matters" sections explain the consequences of leaving the identified issues untreated (safety, property deterioration, rising maintenance costs, compliance, appearance) - factual urgency drawn ONLY from what was actually observed, never fear-mongering or invented risks.
- "programme" sections outline the project stages, access arrangements, expected duration and completion/sign-off process, using only known facts and flagging what is still to be confirmed.

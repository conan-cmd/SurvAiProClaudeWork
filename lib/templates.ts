...
export const TEMPLATES: TemplateDef[] = [
  ...
  },
  {
    ...
    description: "The full high-conversion journey: understanding, findings, stakes, solution, proof, scope, programme.",
    bestFor: "High-value or commercial work where trust wins the job",
    sections: [
      { type: "cover", title: "Cover", aiGenerated: false },
      { type: "understanding", title: "Our Understanding of Your Requirements", aiGenerated: true },
      { type: "findings", title: "Survey Findings", aiGenerated: true },
      { type: "photos", title: "Required Work - Site Photos", aiGenerated: false },
      { type: "why_matters", title: "Why This Matters", aiGenerated: true },
      { type: "solution", title: "Our Recommended Solution", aiGenerated: true },
      { type: "why_choose_us", title: "Why Choose Us", aiGenerated: false },
      { type: "about_us", title: "About Us", aiGenerated: false },
      { type: "scope", title: "Scope of Works", aiGenerated: true },
      { type: "programme", title: "Programme & Methodology", aiGenerated: true },
      { type: "pricing", title: "Investment", aiGenerated: false },
      { type: "terms", title: "Terms and Conditions", aiGenerated: false },
    ],
  },
